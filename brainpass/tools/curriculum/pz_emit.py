...
TITLES = {
    "1.1.1": ("Filling the box", "Both sides of the equals sign must be the same."),
    "1.1.2": ("Taking away and tens", "Check a take away by adding back."),
    "1.1.3": ("Two steps", "Undo the last step first."),
    "1.1.4": ("Missing numbers", None),
    "1.2.1": ("Getting more, giving away", "Getting more means add. Giving away means take away."),
...
TEACH_PICS = {
    "1.1.1": {"kind": "equation", "left": 5, "op": "+", "right": 4, "result": 9, "hide": "right", "reveal": 4},
    "1.1.2": {"kind": "equation", "left": 12, "op": "-", "right": 7, "result": 5, "hide": "right", "reveal": 7},
    "1.1.3": card(["I am a number.", "I add 2, then double.", "Now I am 10."], "So I am 3."),
    "1.2.1": card(["Om has 6 kites.", "He gets 3 more.", "How many now?"], "6 and 3 more is 9."),
    "1.2.2": {"kind": "bars", "names": ["Aman", "Diya"], "values": [10, 6],
              "shown": {"top": 10, "low": 6, "diff": None}, "hide": "diff", "reveal": 4},
    "1.2.3": card(["There are 2 bags.", "Each bag has 5 sweets.", "How many sweets in all?"],
                  "5 and 5 is 10."),
    "1.3.1": {"kind": "series", "terms": [2, 4, 6, 8, 10], "showSteps": True},
    "1.3.2": {"kind": "series", "terms": [5, 8, 11, 14, 17], "showSteps": True},
    "1.3.3": {"kind": "series", "terms": [1, 2, 4, 7, 11], "showSteps": True},
